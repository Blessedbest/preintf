...
/**
 * is_printable - function to evaluate 
...
/**
 * append_hexa_code - function to append ascci
...
/**
 * convert_size_number - function to cast a
...
/**
 * convert_size_unsgnd - function to cast a
 * number to the specified size
 * @num: Number to be casted
